 ...
 * @description: AI Family 中心页 — 家园空间入口网格 + 家人卡片 + 直通 Dynasty
 */
import React from "react";
import { UserCircle2, Crown, Sparkles, MessageSquare, Music, Phone, Settings, BookOpen, Activity } from "lucide-react";
...
const HOME_SPACES = [
  ...
  { id: "dynasty",   label: "王朝治理", icon: Crown,          color: "#C9A96E", desc: "三省六部制" },
