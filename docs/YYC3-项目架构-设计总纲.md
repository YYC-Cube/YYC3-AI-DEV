...
│   ├── plugin-dynasty/        ← 13 朝代 · 12 Agent · 17 勋章 · 26 Skills · 六阶段工作流
...
| plugin-dynasty | 6 文件 (agents/dynasties/edict/honors/workflow/register) | 38 | 12 Agent / 13 朝代 / 6 阶段 / 17 勋章 / 26 Skills |
...
/court                    → 朝堂大厅 (CourtHall · 12 Agent)
/timeline                 → 十三王朝时间轴
/honors                   → 勋章墙 (17 勋章)
/edict                    → 旨意板 (六阶段流转)
/dynasty/skills          → 中华 Skills (26 项)
